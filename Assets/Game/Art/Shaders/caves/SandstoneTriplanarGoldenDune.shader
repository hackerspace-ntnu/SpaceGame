Shader "SpaceGame/SandstoneTriplanarGoldenDune"
{
    Properties
    {
        [Header(Triplanar Rock Colors  Lighter base sand browns)]
        _ColorX ("Color X (Side walls)", Color) = (0.85, 0.66, 0.32, 1)
        _ColorY ("Color Y (Floor / ceiling)", Color) = (0.92, 0.74, 0.38, 1)
        _ColorZ ("Color Z (Front / back walls)", Color) = (0.80, 0.61, 0.28, 1)
        ...
        _SandColor1 ("Sand Color 1 (Pale Cream)", Color) = (1.0, 0.95, 0.72, 1)
        _SandColor2 ("Sand Color 2 (Light Sand)", Color) = (0.99, 0.86, 0.52, 1)
        _SandColor3 ("Sand Color 3 (Soft Tan)", Color) = (0.97, 0.81, 0.46, 1)
        ...
        _AccentColor ("Accent Color", Color) = (0.83, 0.58, 0.24, 1)
