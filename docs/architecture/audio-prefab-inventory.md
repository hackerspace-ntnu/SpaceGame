...
the 69 slots and what each currently resolves to. **This** doc lists the prefabs, and for each one
the trigger that fires a sound and what that sound should be — the shopping list for an audio pass.
