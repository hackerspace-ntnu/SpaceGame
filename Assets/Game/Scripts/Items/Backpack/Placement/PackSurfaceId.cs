namespace SpaceGame.Items
{
    ...
    public enum PackSurfaceId : byte
    {
        ...
        /// 0.86 x 0.72 m, whose <em>diagonal</em> — the longest segment that fits inside a
        /// rectangle at all — is 1.1216 m, so the 1.35 m LaserStaff fits none of them at any yaw.
        ...
        /// <summary>
        /// <c>SURF_Rack</c>: the 0.80 x 0.60 m face of the front leaf once it has been flipped up
        /// into a vertical rack — the leaf's UNDERSIDE, which is the side that ends up pointing at
        /// the player when the leaf stands.
        ///
        /// <para>
        /// It is the biggest rectangle on the rig at 0.48 m&#178;, and the only one with both axes
        ...
        /// 0.50 m deep, so a wing panel or a crate that is 0.6 m across fits nowhere at any yaw.
        /// </para>
        /// <para>
