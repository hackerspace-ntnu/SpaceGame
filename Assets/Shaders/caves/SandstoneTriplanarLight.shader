Shader "SpaceGame/SandstoneTriplanarLight"
{
    Properties
    {
        [Header(Triplanar Rock Colors  Lighter base sand browns)]
        _ColorX ("Color X (Side walls)", Color) = (0.66, 0.54, 0.40, 1)
        _ColorY ("Color Y (Floor / ceiling)", Color) = (0.72, 0.60, 0.45, 1)
        _ColorZ ("Color Z (Front / back walls)", Color) = (0.62, 0.50, 0.37, 1)
        ...
        _SandColor1 ("Sand Color 1 (Pale Cream)", Color) = (0.97, 0.92, 0.78, 1)
        _SandColor2 ("Sand Color 2 (Light Sand)", Color) = (0.90, 0.80, 0.62, 1)
        _SandColor3 ("Sand Color 3 (Soft Tan)", Color) = (0.93, 0.85, 0.68, 1)
        ...
        _AccentColor ("Accent Color", Color) = (0.72, 0.52, 0.50, 1)
