...
{
    /// <summary>
    /// Which UGS profile a process signs in under — see <see cref="SessionProfile.Resolve"/>.
    ///
    ...
    public class SessionProfileTests
    {
        ...
        public void NoFlags_KeepsTheDefaultProfile()
        {
            ...
            Assert.IsNull(SessionProfile.Resolve(new[] { "SpaceGame.exe" }, NormalPath));
        }
        ...
        public void ExplicitFlag_NamesTheProfile()
        {
            Assert.AreEqual("client",
                SessionProfile.Resolve(new[] { "SpaceGame.exe", "-sgprofile", "client" }, NormalPath));
        }
        ...
        public void ExplicitFlag_BeatsEveryOtherSource()
        {
            ...
            Assert.AreEqual("chosen", SessionProfile.Resolve(args, NormalPath));
        }
        ...
        public void ExplicitFlag_WithNoValue_IsIgnored()
        {
            ...
            Assert.IsNull(SessionProfile.Resolve(new[] { "SpaceGame.exe", "-sgprofile" }, NormalPath));
        }
        ...
        public void VirtualPlayer_UsesItsInstanceName()
        {
            ...
            Assert.AreEqual("Player2", SessionProfile.Resolve(args, NormalPath));
        }
        ...
        public void NameAlone_IsNotAVirtualPlayer()
        {
            ...
            Assert.IsNull(SessionProfile.Resolve(new[] { "Unity", "-name", "Player2" }, NormalPath));
        }
        ...
        public void CloneProject_ProfilesOffTheCloneSuffix()
        {
            ...
            Assert.AreEqual("clone_0",
                SessionProfile.Resolve(new[] { "Unity" }, "/Users/dev/SpaceGame_clone_0/Assets"));
        }
        ...
        public void CloneProject_StopsAtThePathSeparator()
        {
            Assert.AreEqual("clone_1",
                SessionProfile.Resolve(new[] { "Unity" }, "/Users/dev/SpaceGame_clone_1/Assets/Sub"));
        }
        ...
        public void Profile_IsSanitisedToWhatTheSdkAccepts()
        {
            ...
            Assert.AreEqual("Player_2_x",
                SessionProfile.Resolve(new[] { "x", "-sgprofile", "Player 2:x" }, NormalPath));
        }
        ...
        public void Profile_IsTruncatedToThirtyCharacters()
        {
            ...
            string resolved = SessionProfile.Resolve(new[] { "x", "-sgprofile", overlong }, NormalPath);
        ...
        {
            Assert.IsNull(SessionProfile.Resolve(new[] { "x", "-sgprofile", "   " }, NormalPath));
        }
    }
}
