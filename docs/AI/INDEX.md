...
| [CarriedAgent](systems/CarriedAgent.md) | A rope lifts a NavMesh creature off its own mesh; the motor carries it, falls it, and lands it back on | [AgentSystem](systems/AgentSystem.md), [LeashSystem](systems/LeashSystem.md), [Jetpack](systems/Jetpack.md), [Locomotion](systems/Locomotion.md), [NavMeshSystem](systems/NavMeshSystem.md) |
...
| [BottledSingularity](systems/BottledSingularity.md) | A thrown bottle that inhales everything within 8 m, holds it in a white void for 5 s, and spits it back out | [Artifacts](systems/Artifacts.md), [Multiplayer](systems/Multiplayer.md), [Combat](systems/Combat.md) |
...
| [FoamGun](systems/FoamGun.md) | Standable lumps laid along a ballistic arc: a violent particle jet in front, welded spheres behind | [Artifacts](systems/Artifacts.md), [Multiplayer](systems/Multiplayer.md), [Persistence](systems/Persistence.md) |
