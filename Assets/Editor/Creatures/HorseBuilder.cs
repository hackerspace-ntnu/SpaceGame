...
//
// The model is generated from Assets/Models/_Source~/models/creatures/horse_robot.py and exported by
// horse_robot_export.py -- see Assets/Models/_Source~/models/creatures/horse_robot_BUILD.md.
//
    ...
    public static void Build()
    {
        ...
        if (model == null)
        {
            Debug.LogError($"[Horse] No model at {ModelPath}. Run " +
                           "Assets/Models/_Source~/models/creatures/horse_robot_export.py first.");
            return;
        }
