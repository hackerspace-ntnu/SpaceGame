Shader "SpaceGame/SandstoneTriplanarSaltFlat"
{
    Properties
    {
        [Header(Triplanar Rock Colors  Lighter base sand browns)]
        _ColorX ("Color X (Side walls)", Color) = (0.80, 0.79, 0.76, 1)
        _ColorY ("Color Y (Floor / ceiling)", Color) = (0.85, 0.84, 0.81, 1)
        _ColorZ ("Color Z (Front / back walls)", Color) = (0.77, 0.76, 0.73, 1)
        ...
        _SandColor1 ("Sand Color 1 (Pale Cream)", Color) = (0.98, 0.98, 0.96, 1)
        _SandColor2 ("Sand Color 2 (Light Sand)", Color) = (0.94, 0.94, 0.91, 1)
        _SandColor3 ("Sand Color 3 (Soft Tan)", Color) = (0.96, 0.95, 0.90, 1)
        ...
        _AccentColor ("Accent Color", Color) = (0.78, 0.80, 0.83, 1)
