...
reads_with: [Artifacts, Hogtie, Lasso, Multiplayer, Persistence, PlayerCharacter, Locomotion, RopeCutting]
updated: 2026-09-07
---
...
- **Strain only builds while the rope is taut** (`Leash.IsTaut`). Without that gate, throwing yourself about beside a knot you are standing next to would tear the rope off without it ever having gone tight.
