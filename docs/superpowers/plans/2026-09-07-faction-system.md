...
| **4** Rosters and tribes (incl. **4.5 traders**) | **not started** | no `FactionRoster`, no `Rosters/` folder, no Mechanics/Sky faction, no `TerritoryZone` |
...
[implementation plan](2026-09-16-rosters-and-war-parties.md).
