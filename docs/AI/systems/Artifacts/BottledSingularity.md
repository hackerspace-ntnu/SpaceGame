...
A thrown bottle that inhales everything within 8 m for 1.5 s, holds it in a knot, then flings it all
back out. It does not know who threw it.

## What it does

Throw the bottle. Where it lands it opens: for 1.5 s everything loose within 8 m is dragged toward the
...
the hole gulps, collapses, and everything it caught is *gone from the world* for two and a half seconds before
it is spat back out. The brief's inhale is now the first of six phases, and every duration has since been halved. See
...
An unthrown bottle is an ordinary item with a charge. A bottle mid-effect is a few seconds of world state and
