...
// Assets/Models/Vehicles/DuneFoil/dune_foil_rig.fbx, and the Wind prefab that drives it.
//
// The FBX already carries the rig — pivots, named parts, subdivided sails — because
// Assets/Models/_Source~/models/vehicles/dune_foil_rig.py put them there. What this script adds is everything
...
public static class DuneFoilBuilder
{
    ...
    private const string ModelPath = "Assets/Models/Vehicles/DuneFoil/dune_foil_rig.fbx";
    ...
    private const string MaterialFolder = "Assets/Models/Vehicles/DuneFoil/Materials";
    ...
    public static void Build()
    {
        ...
        if (source == null)
        {
            Debug.LogError($"[DuneFoilBuilder] No model at {ModelPath}. Run " +
                           "Assets/Models/_Source~/models/vehicles/dune_foil_rig.py first:\n" +
