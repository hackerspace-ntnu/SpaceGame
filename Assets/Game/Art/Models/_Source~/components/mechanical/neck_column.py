...
Lifted from the ostrich's neck (`Assets/Game/Art/Models/Creatures/Robotic/
...
REPO = REPO_ROOT
OSTRICH = os.path.join(REPO, "Assets", "Models", "Creatures", "Robotic",
                       "Ostrich", "ostrich_neck.blend")
