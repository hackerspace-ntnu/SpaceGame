...
//
// The model is generated from Assets/Models/_Source~/models/vehicles/dune_ornithopter.py and exported by
// dune_ornithopter_export.py -- see Assets/Models/_Source~/models/vehicles/dune_ornithopter_BUILD.md.
//
    ...
    public static void Build()
    {
        ...
        if (model == null)
        {
            Debug.LogError($"[Ornithopter] No model at {ModelPath}. Run " +
                           "Assets/Models/_Source~/models/vehicles/dune_ornithopter_export.py first.");
            return;
        }
