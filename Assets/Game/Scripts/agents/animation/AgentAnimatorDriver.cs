...
namespace SpaceGame.Agents
{
    public class AgentAnimatorDriver : MonoBehaviour
    {
        ...
        ///
        /// <para>
        /// The counterpart of <see cref="TriggerByName"/>, and guarded more heavily than it needs
        /// to be for a one-shot: a held flag is written every frame, so an Animator with no
        /// controller — or a controller without this parameter — would turn one warning per call
        /// into one per frame per creature.
        /// </para>
        /// </summary>
